...
- 2026-08-30 · chips：新的 GPU 或镜像路径在什么工作负载下因 SM、显存、互连或编译选择而不能稳定兑现标称吞吐？
- 2026-08-30 · infra-capital：哪份新披露把数据中心容量、融资、交付、用电或网络承诺转换成可验证的数量、日期或风险条款？
- 2026-08-30 · models-agents：哪个模型或 agent 的价格、权限、会话恢复或流式协议变化能直接改变团队的可控性或单位任务成本？
- 2026-08-30 · inference-systems：哪条推理路径本周用 P99、正确性、资源驻留或跨节点数据面证明某个 overlap/缓存策略应被开启或禁用？
- 2026-08-30 · papers-oss：哪篇论文或开源实现同时公开了现实请求负载、端到端对照、失败条件与可复跑工件？
- 2026-08-30 · china-industry：国产 GPU 或中文模型栈是否新增可复核的硬件适配、量化、通信或交付事实，而非营销性参数？
- 2026-08-30 · community：哪位具名维护者或部署者公开了包含环境、最小复现与量化后果的回归、事故或反例？
- 2026-08-30 · deepseek-radar：DeepSeek 官方仓库或第三方集成是否新增可验证的模型、内核、通信、缓存或评测资产？
...
- 2026-08-28 · inference-systems：哪个 decode、MoE 或 KV 路径本周因缓存、graph 或 rank 局部状态需要显式选择或回退？
- 2026-08-28 · papers-oss：哪些本周的系统改动同时提供负载、硬件、正确性门槛和可否证的端到端量化？
- 2026-08-28 · china-industry：国产或中文模型栈在新卡、CPU/NPU 或异构通信上出现了什么具体容量或兼容性边界？
- 2026-08-28 · community：维护者本周公开的回退、revert、CI 失败或配置误用，哪个具有量化生产影响？
- 2026-08-28 · deepseek-radar：DeepSeek V4 集成在本周新增了哪些 MoE、SWA、EPLB 或 PD 的拓扑/内存约束？
